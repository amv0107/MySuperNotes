...
enum class DataStoreFormatDateTime(val title: String, val pattern: String) {
    ...
    PATTERN_9("2024-12-31 - 13:32", "yyyy-MM-dd - HH:mm"),
    PATTERN_10("2024-31-12 - 13:32", "yyyy-dd-MM - HH:mm"),
    PATTERN_11("31.12.2024 - 13:32", "dd.MM.yyyy - HH:mm"),
    PATTERN_12("2024.12.31 - 13:32", "yyyy.MM.dd - HH:mm"),
    PATTERN_13("2024.31.12 - 13:32", "yyyy.dd.MM - HH:mm"),
}